...
def process_game(game, odds_events, season_scoring, trailing_scoring, today,
    ...
    home_starter_xwoba = df.get_pitcher_xwoba_against(game["home_probable"], season) if game["home_probable"] else None
    away_starter_xwoba = df.get_pitcher_xwoba_against(game["away_probable"], season) if game["away_probable"] else None
    ...
    home_bullpen = bgi.build_bullpen(xwoba_against_season=df.get_bullpen_xwoba_against(home_abbrev, season))
    away_bullpen = bgi.build_bullpen(xwoba_against_season=df.get_bullpen_xwoba_against(away_abbrev, season))
